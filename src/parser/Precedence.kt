...
const val EXPR_APPLICATION_ACCESS_PRECEDENCE: Int = 10
...
fun getExprPrecedenceForInfixToken(tokenType: TokenType): Int = when (tokenType) {
    ...
    TokenType.PERIOD -> EXPR_APPLICATION_ACCESS_PRECEDENCE
    TokenType.LEFT_BRACKET -> EXPR_APPLICATION_ACCESS_PRECEDENCE
    TokenType.LEFT_PAREN -> EXPR_APPLICATION_ACCESS_PRECEDENCE
