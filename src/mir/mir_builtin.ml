 ...
 *)
let myte_alloc =
  { Builtin.name = "myte_alloc"; mk_return_ty = (fun tys -> Some (`PointerT (List.hd tys))) }
 ...
 *)
let myte_copy = { Builtin.name = "myte_copy"; mk_return_ty = (fun _ -> None) }
 ...
 *)
let myte_exit = { Builtin.name = "myte_exit"; mk_return_ty = (fun _ -> None) }
 ...
 *)
let myte_write = { Builtin.name = "myte_write"; mk_return_ty = (fun _ -> Some `IntT) }
 ...
 *)
let myte_read = { Builtin.name = "myte_read"; mk_return_ty = (fun _ -> Some `IntT) }
 ...
 *)
let myte_open = { Builtin.name = "myte_open"; mk_return_ty = (fun _ -> Some `IntT) }
 ...
 *)
let myte_close = { Builtin.name = "myte_close"; mk_return_ty = (fun _ -> Some `IntT) }
...
let mk_call_builtin builtin var_id args mk_return_ty_args =
  ...
  (result_val, Instruction.CallBuiltin { return = Some (var_id, return_ty); func = builtin; args })

let mk_call_builtin_no_return builtin args =
  Instruction.CallBuiltin { return = None; func = builtin; args }
